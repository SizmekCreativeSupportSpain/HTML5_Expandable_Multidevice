...
function handleOrientation(m) {
    if(m.matches) {
        bannerContainer.style.width = adConfig.mobile_expanded_with;
        bannerContainer.style.height = adConfig.mobile_expanded_height;
    }
    else {
        bannerContainer.style.width = adConfig.mobile_expanded_height;
        bannerContainer.style.height = adConfig.mobile_expanded_with;
    }
}
